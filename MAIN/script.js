...
function validateRegistrationForm() {
  ...
  var agreeCheckbox = document.getElementById("chkAgree").checked;
  ...
  $("#register").submit(function(e) {
      ...
      $.ajax({
          ...
          success: function(response) {
              // Display registration message returned from connect.php
              $(".form-box").append('<p style="color: green;">' + response.message + '</p>');
          }
      });
  });
});
